...
const static struct phy_msg messages_2d[] = {
	...
	{0x00120000,
	 "PMU0: ------- FFEmeasurements -----\n"
	},
	{0x00130002,
	 "PMU0: FFE_weight %d @ drvStren %d\n"
	},
	{0x0014001f,
	...
	{0x00240002,
	 "PMU4: Delay Stepsize = %d Fine, Voltage Stepsize = %d DAC\n"
	},
	{0x00250002,
	...
	{0x002b0002,
	 "PMU3: 2D Voltages      : %d  %d\n"
	},
	{0x002c0001,
	 "PMU0: input %d\n"
	},
	{0x002d0004,
	 "PMU0: final: range %d center %d -> MIN %d MAX %d\n"
	},
	{0x002e0002,
	 "DEBUG: min %d, max %d\n"
	},
	...
	{0x00300003,
	 "PMU0: seed 1 = (%d,%d). edge at idx %d\n"
	},
	{0x00310003,
	 "PMU0: seed 2 = (%d,%d) edge at idx %d\n"
	},
	{0x00320003,
	...
	{0x003a0000,
	 "PMU1: local_max is 0, stop searching.\n"
	},
	{0x003b0002,
	...
	{0x003f0000,
	 "PMU1: local_max is center, stop searching.\n"
	},
	{0x00400009,
	 "PMU3: center (%3d, %3d) moving (%2i, %2i) -- L %d, R %d, C %d, U %d, D %d\n"
	},
	{0x00410004,
	 "PMU0: max iterations (%d) reached. Final center (%d,%d), weight %d\n"
	},
	{0x00420003,
	...
	{0x00440004,
	 "PMU3: Optimal allFine Center (%d,%d), found in %d (center,left,right) region, with weight %d.\n"
	},
	{0x00450003,
	...
	{0x00480005,
	 "PMU: Error: getCompoundEye Called on lane%d eye with non-compatible (%d delay, %d voltage) centers. %d != %d\n"
	},
	{0x00490001,
	...
	{0x00580003,
	 "PMU3: Merging collected eyes [%d..%d) and analyzing for nibble %d's optimal rxClkDly\n"
	},
	{0x00590000,
	 "PMU0: dumping optimized eye\n"
	},
	{0x005a0000,
	...
	{0x005f0002,
	 "PMU3: Merging collected eyes [%d..%d) and analyzing for optimal device txVref\n"
	},
	{0x00600000,
	 "PMU0: dumping optimized eye\n"
	},
