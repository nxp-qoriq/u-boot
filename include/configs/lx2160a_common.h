...
#if defined(CONFIG_ARCH_LX2160A_CFP)
#define CONFIG_SYS_TEXT_BASE          0x80000000
#define CONFIG_ENV_IS_NOWHERE
#elif defined(CONFIG_ARCH_LX2160A_PXP)
...
#else
#define CONFIG_SYS_SDRAM_BASE		CONFIG_SYS_PEB_BASE
#endif
...
#define CONFIG_SPL_BSS_START_ADDR		0x18030000
#define CONFIG_SPL_BSS_MAX_SIZE		0x00007FFF
#define CONFIG_SYS_SPL_MALLOC_SIZE	       0x00006000
#define CONFIG_SYS_SPL_MALLOC_START	0x18038000
...
#define CONFIG_BOOTARGS		"console=ttyAMA0,115200 root=/dev/ram0 " \
				...
				"ramdisk_size=0x2000000 default_hugepagesz=1024m" \
